// Chiavi distinte da chat-ui per evitare conflitti in browser condivisi:
// l'admin-ui e' una superficie diversa e dovrebbe richiedere login esplicito.
const TOKEN = "aion_admin_token";
const USER = "aion_admin_user_id";
const SKIP = "aion_admin_change_pw_skipped_until";
