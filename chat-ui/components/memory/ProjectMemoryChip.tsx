...
export function ProjectMemoryChip({
  ...
  return (
    <button
      ...
      onClick={onOpenPanel}
      className={cn(
        "focus-ring inline-flex h-7 max-w-[9rem] shrink items-center gap-1 rounded-full border border-primary/25 bg-primary/8 px-2.5 text-[0.786em] font-medium text-primary transition-colors hover:bg-primary/15 sm:max-w-[10rem]",
        className
      )}
    >
