...
def upgrade() -> None:
    ...
    if "mcp_server_configs" not in tables:
        op.create_table(
            ...
            sa.Column("is_enabled_for_users", sa.Boolean(), nullable=False, server_default=sa.text("0")),
            sa.Column("requires_user_credentials", sa.Boolean(), nullable=False, server_default=sa.text("0")),
