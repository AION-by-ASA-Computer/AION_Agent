...
## [1.6.0](https://github.com/AION-by-ASA-Computer/AION_Agent/compare/v1.5.0...v1.6.0) (2026-09-08)
...
* add redis password authentication and update installation directory ownership for sudo users ([521e719](https://github.com/AION-by-ASA-Computer/AION_Agent/commit/521e719890a4e8ba3db41c74d933edad88707e7d))
* add redis password authentication and update installation directory ownership for sudo users ([95cea63](https://github.com/AION-by-ASA-Computer/AION_Agent/commit/95cea631de4530f065806c1f3a866c8db0883f88))
* add standalone installer script and update documentation to simplify deployment ([d862a67](https://github.com/AION-by-ASA-Computer/AION_Agent/commit/d862a67fe4de41db1a50757e6cc11e681b6607f4))
* add standalone installer script and update documentation to simplify deployment ([14b5c4e](https://github.com/AION-by-ASA-Computer/AION_Agent/commit/14b5c4ec9192eeecbf25e23fa03333139b6a61d3))
...
* implement robust credential decryption with error handling, validation, and diagnostic feedback for invalid keys ([831e0ce](https://github.com/AION-by-ASA-Computer/AION_Agent/commit/831e0cea160a69be8bf655deea58bca167993b97))
...
* refactor GHCR docker-compose stack to include full service definitions and update runtime dependencies ([98607a7](https://github.com/AION-by-ASA-Computer/AION_Agent/commit/98607a7f15da2b8047631510880f20eaa8a901da))
* refactor GHCR docker-compose stack to include full service definitions and update runtime dependencies ([bcfeec5](https://github.com/AION-by-ASA-Computer/AION_Agent/commit/bcfeec52cd520b8b4cd0894d18d5d35615a6322a))
...
* updates ghcr ([cc0ce2e](https://github.com/AION-by-ASA-Computer/AION_Agent/commit/cc0ce2ebbb3764f1e2d301803fb4673a4c6d8e11))
