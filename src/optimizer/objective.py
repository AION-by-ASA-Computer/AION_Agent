...
def aion_agent_objective(trial):
    ...
    # 3. Execution
    dataset = os.getenv("AION_OPTIMIZER_DATASET", "data/eval_datasets/optimization_base.json")
    ...
    if os.path.exists(dataset):
        ...
        try:
            ...
            score = loop.run_until_complete(run_evaluation(dataset, "AION Core", threshold=0.0))
            return score
